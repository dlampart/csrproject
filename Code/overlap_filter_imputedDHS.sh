#!/bin/bash
mkdir Data/roadmapCollected/
mkdir Data/roadmapDHS_filtered/
...
do
    echo $el
    bedops --ec -e -1 Data/roadmapDHS/${el}-DNase.imputed.narrowPeak.bed Data/roadmapCollected/all_merged.bed > Data/roadmapDHS_filtered/${el}-DNase.imputed.narrowPeak.bed
done
